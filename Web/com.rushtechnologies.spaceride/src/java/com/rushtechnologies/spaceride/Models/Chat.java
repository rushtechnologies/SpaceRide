...
public class Chat {
    ...
    public String toString() {
        return "Chat{" + "Chat_Id=" + Chat_Id + ", Chat_S_Id=" + Chat_S_Id + ", Chat_U_Id=" + Chat_U_Id + ", Chat_U_Msgs=" + Chat_U_Msgs + ", Chat_S_Msgs=" + Chat_S_Msgs + ", Chat_Time=" + Chat_Time + ", Chat_Timestamp=" + Chat_Timestamp + '}';
    }
