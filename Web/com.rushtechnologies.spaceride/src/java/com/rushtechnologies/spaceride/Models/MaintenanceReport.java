...
public class MaintenanceReport {
    ...
    public String toString() {
        return "MaintenanceReport{" + "MR_Id=" + MR_Id + ", MR_Module=" + MR_Module + ", MR_Description=" + MR_Description + ", MR_Status=" + MR_Status + ", MR_Solution=" + MR_Solution + ", MR_S_Id=" + MR_S_Id + ", MR_Timestamp=" + MR_Timestamp + '}';
    }
}
