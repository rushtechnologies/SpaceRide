...
public class Faq {
    ...
    public String toString() {
        return "Faq{" + "faq_id=" + faq_id + ", faq_pregunta=" + faq_pregunta + ", faq_respuesta=" + faq_respuesta + ", faq_tema=" + faq_tema + ", faq_prioridad=" + faq_prioridad + ", faq_aprobacion=" + faq_aprobacion + ", faq_u_id=" + faq_u_id + ", faq_a_id=" + faq_a_id + '}';
    }
