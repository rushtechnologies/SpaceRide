...
/**
 * Servlet controller for Stats chart in profile page
 * 
 * @version 1.0
 * @author CARLOSHG
 */
...
public class ChartController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            out.println(gson.toJson(user.readU_derrotasAndU_victorias(Integer.parseInt(session.getAttribute("id").toString()))));
        }
    }
