...
public class EventReport {
    ...
    public EventReport(int ER_Id, int ER_U_Id, String ER_Transcript, String ER_Description, String ER_Category, String ER_Status, String ER_Solution, int ER_S_Id, Timestamp ER_Timestamp) {
        this.ER_Id = ER_Id;
    ...
    public String toString() {
        return "EventReport{" +
                "ER_Id=" + ER_Id +
                ", ER_U_Id=" + ER_U_Id +
                ", ER_Transcript=" + ER_Transcript +
                ", ER_Description=" + ER_Description +
                ", ER_Category=" + ER_Category +
                ", ER_Status=" + ER_Status +
                ", ER_Solution=" + ER_Solution +
                ", ER_S_id=" + ER_S_Id +
                ", ER_Timestamp=" + ER_Timestamp +
                '}';
    }
