 ...
 * 
 */
@WebServiceClient(name = "Login", targetNamespace = "http://WebService.spaceride.rushtechnologies.com/", wsdlLocation = "http://localhost:8080/com.rushtechnologies.spaceride/Login?wsdl")
    ...
    extends Service
{
    ...
    private final static QName LOGIN_QNAME = new QName("http://WebService.spaceride.rushtechnologies.com/", "Login");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/com.rushtechnologies.spaceride/Login?wsdl");
    ...
    public Login getLoginPort() {
        return super.getPort(new QName("http://WebService.spaceride.rushtechnologies.com/", "LoginPort"), Login.class);
    }
    ...
    public Login getLoginPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://WebService.spaceride.rushtechnologies.com/", "LoginPort"), Login.class, features);
    }
