...
public class ObjectFactory {
    ...
    private final static QName _Login_QNAME = new QName("http://WebService.spaceride.rushtechnologies.com/", "login");
    private final static QName _LoginResponse_QNAME = new QName("http://WebService.spaceride.rushtechnologies.com/", "loginResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://WebService.spaceride.rushtechnologies.com/", name = "login")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://WebService.spaceride.rushtechnologies.com/", name = "loginResponse")
