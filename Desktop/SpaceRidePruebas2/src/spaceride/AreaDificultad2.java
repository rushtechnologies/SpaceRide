 ...
 * @author CARLOSHG
 */
public class AreaDificultad2 extends JFrame implements ActionListener {
    ...
    public AreaDificultad2(User user1, int user2id) {

        this.user1 = user1;
        user1id = this.user1.getUserid();
        ...
        tittle.setText(read(user1id) + " vs. " + read(this.user2id));
        ...
        description.setText("Selecciona el área del desafio de conocimientos de " + read(this.user2id));
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == areas[0]) {
            ...
            if (gamedifficulty.equals("")) {
                ...
                user2 = new User(user2id, gamearea, gamedifficulty);
                Inicio inicia = new Inicio(user1, user2);
                dispose();
            }
        } else {
        ...
        if (ae.getSource() == back){
            AreaDificultad back = new AreaDificultad(user1id, user2id);
        }
    }
