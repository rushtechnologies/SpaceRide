...
public class Inicio2 extends JFrame implements ActionListener{
    ...
    public Inicio2(int user1id) {
        ...
        description2.setText("Inicio de sesión del jugador 2");
            ...
            switch(logincase){
                ...
                case 1:
                    if(user1id != user2id){
                        ...
                        AreaDificultad configura = new AreaDificultad(user1id, user2id);
                        dispose();
                    } else{
                        JOptionPane.showMessageDialog(user,"Los jugadores deben de ser usuarios diferentes");
                        user.setText("");
                        pass.setText("");
                    }
                    break;
